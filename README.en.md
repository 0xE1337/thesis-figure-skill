...
- **Embedded Data Visualization** (NEW): Embed heatmaps, bar charts, waveforms, radar charts, scatter plots inside architecture diagrams — show structure + data in one figure
...
- **Designer-Level Review**: Three-pass review (overall feel → element-by-element → connection paths), detecting overlap/collision/unnatural layouts
...
- **Automatic Experience Logging**: 45 lessons learned, automatically reused across sessions
